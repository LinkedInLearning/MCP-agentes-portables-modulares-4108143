...
class LLMClient:
    ...
    #     """
    #     url = "https://oai-mgr2.openai.azure.com/"
...
class ChatSession:
    ...
    async def start(self) -> None:
        ...
        try:
            ...
            # Format the tools of all tools for OpenAI
            # "type": "function",
            #     "function": {
            #         "name": tool.name,
            ...
            while True:
                try:
                    ...
                    logging.info("\nAssistant: %s", llm_response.choices[0].message)

                    assistant_message = llm_response.choices[0].message

                    messages = [{"role": "user", "content": user_input}, {"role": "assistant", "content": assistant_message}]
                    ...
                    if assistant_message.tool_calls:
                        ...
                        logging.info("\nFinal response: %s", final_response.choices[0].message.content)
...
async def main() -> None:
    ...
    llm_client = AsyncAzureOpenAI(api_key=config.llm_api_key, api_version="2024-12-01-preview", azure_endpoint="https://oai-mgr2.openai.azure.com/")
